...
def check(message):
    ...
    nano = types.InlineKeyboardButton(text='Нано-квантум', callback_data='nano-kv')
    keyboard.add(it_check, auto_check, nano)
...
def knopka(call):
    ...
    if call.data == 'it_course':
        ...
        group2_button = types.InlineKeyboardButton(text='Группа Н2 сет. 35 школа', callback_data='group_n2')



        keyboard.add(group1_button,group2_button)
